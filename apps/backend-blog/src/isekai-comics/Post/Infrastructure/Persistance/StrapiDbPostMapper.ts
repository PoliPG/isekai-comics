...
export type ContentComponents = Registry.Keys<Common.Schemas, UID.Component<'content'>>
export type DynamicZoneValue = Attribute.GetDynamicZoneValue<Attribute.DynamicZone<ContentComponents[]>>[0]
...
export class StrapiDbPostMapper {
    ...
    static createFromDB(post: StrapiDbPost): Post {
        ...
        return new Post(post.id as number, post.Title, post.MetaTitle, post.MetaDescription, contentBlocks)
    }

    private static createContentBlock(contentBlock: DynamicZoneValue): PostContent {
